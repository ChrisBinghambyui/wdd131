data = [7, 1, 4, 2, 9, 3, 5, 10, 99, 99, 100, -292, 85, 0]
length = len(data)
...
# I think this is O(n^2), because it loops based on the length of the dataset, making it increase exponentially as each nummber has to be compared to each other number. At first i thought it was O(n), but it's not a static increase.
