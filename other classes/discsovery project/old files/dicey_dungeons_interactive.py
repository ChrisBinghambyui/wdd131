...
def main():
    ...
    print("1) WARRIOR - Extra HP and damage")
    print("2) ROGUE - More dice, less HP")
    print("3) CLERIC - Balanced, healing focus")
    
    clas = get_valid_input("Make your choice (1-3)> ", [1, 2, 3])
    ...
    print(f"\n✨ And so begins the tale of {charname.capitalize()}, the {charclass}!")
