...
#         print(f"{cleaned_name}, {periodic_table[symbol][1]}")
...
def main():
    ...
    sample_mass = float(input("Enter the weight in grams:\n\t>"))
    print("")
