...
def main():
    people_dict = {
        ...
        "P143": ["Lola Park", "F", 1663, 1706, 0],
        "P338": ["Savanna Foster", "F", 1674, 1723, 0],
        "P201": ["Tiffany Hughes", "F", 1689, 1747, 0],
        "P203": ["Ignacio Torres", "M", 1693, 1758, 0],
        "P128": ["Yasmin Li", "F", 1701, 1716, 0],
        "P342": ["Trent Ross", "M", 1695, 1752, 0],
        "P202": ["Samyukta Nguyen", "M", 1717, 1774, 0],
        "P132": ["Joel Johnson", "M", 1724, 1800, 0],
        "P445": ["Whitney Nelson", "F", 1737, 1803, 0],
        "P318": ["Khalid Ali", "M", 1759, 1814, 0],
        "P317": ["Davina Patel", "F", 1775, 1860, 0],
        "P313": ["Enzo Ruiz", "M", 1782, 1782, 0],
        "P475": ["Lauren Smith", "F", 1800, 1802, 0],
        "P455": ["Lucas Ross", "M", 1800, 1853, 0],
        "P435": ["Jamal Gray", "M", 1810, 1831, 0],
        "P204": ["Fatima Soares", "F", 1812, 1898, 0],
        "P206": ["Ephraim Foster", "M", 1831, 1885, 0],
        "P500": ["Peter Price", "M", 1802, 1858, 0],
        "P207": ["Rosalina Jimenez", "F", 1875, 1956, 0],
        "P425": ["Rachel Johnson", "F", 1876, 1940, 0],
        "P121": ["Vanessa Bennet", "F", 1880, 1960, 0],
        "P152": ["Jose Castillo", "M", 1884, 1931, 0],
        "P205": ["Liam Myers", "M", 1902, 1950, 0],
        "P465": ["Isabella Lopez", "F", 1907, 1959, 0],
        "P168": ["Megan Anderson", "F", 1899, 1945, 0]
    }
...
def print_death_age(people_dict):
    ...
    for person_data in people_dict.values():
        ...
        birth = person_data[BIRTH_YEAR_INDEX]
        death = person_data[DEATH_YEAR_INDEX]

        age_at_death = death - birth
        print(f"{name} was born in {birth} and died in {death} around the age of {age_at_death}.")
...
def count_genders(people_dict):
    ...
    print(f"The provided list contains {men} men and {women} women.")
    ...
...
def print_marriages(marriages_dict, people_dict):
    ...
    for marriage_data in marriages_dict.values():
        husband_id = marriage_data[HUSBAND_KEY_INDEX]
        wife_id = marriage_data[WIFE_KEY_INDEX]
        wedding = marriage_data[WEDDING_YEAR_INDEX]
        ...
        print(f"{husband_name} ({husband_age}) and {wife_name} ({wife_age}) were married in {wedding}.")
    
    print("")

    for person_data in people_dict.values():
        person_data[MARRIAGE_COUNT_INDEX] = 0

    for marriage_data in marriages_dict.values():
        husband_id = marriage_data[HUSBAND_KEY_INDEX]
        wife_id = marriage_data[WIFE_KEY_INDEX]
        people_dict[husband_id][MARRIAGE_COUNT_INDEX] += 1
        people_dict[wife_id][MARRIAGE_COUNT_INDEX] += 1

    for person_data in people_dict.values():
        name = person_data[NAME_INDEX]
        count = person_data[MARRIAGE_COUNT_INDEX]
        print(f"{name} was married {count} times.")
