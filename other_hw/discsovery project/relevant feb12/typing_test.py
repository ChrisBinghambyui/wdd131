...
typingPrint("Welcome to DICE DUNGEON.")

typingPrint("In Dice Dungeon, you will use your magical dice to activate spellcards to ensure victory on your adventures. Try each class, refine your strategy, and triumph!")
...
def run_basic_combat_loop(current_biome, current_biome_tier=1, player_hp=None, player_max_hp=None, player_deck=None, auto_player=False, legendary_enemy=False):
  ...
  _reset_combat_state(player_actor)
  _reset_combat_state(enemy_actor)
  typingPrint("You were reduced to 0 HP or less and retreat to base camp.")
  return {
    "result": "retreat",
    "player_hp": player_actor.hp,
    "enemy": enemy_actor.name,
...
while play!="quit":
  ...
  typingPrint("...")
  typingPrint("...")
  typingPrint("You remember the smell of the sea...", delay=1.5)
  typingPrint("...")
  typingPrint("...")
  typingPrint("You remember the swaying of the ship...", delay=1.5)
  typingPrint("...")
  typingPrint("...")
  typingPrint("You remember..."+Style.BRIGHT+Fore.CYAN+ "lightning...", delay=1.5)
  typingPrint(Style.RESET_ALL + "...")
  typingPrint(Style.DIM+Fore.CYAN+"Wind...", delay=1.5)
  typingPrint(Style.RESET_ALL + "...")
  typingPrint("And then the icy grip of the sea...", delay=1.5)
  typingPrint("...")
  typingPrint("...")
  typingPrint("...")
  typingPrint("...")
